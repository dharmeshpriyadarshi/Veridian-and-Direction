...
class LSTMBaseModel:
    def __init__(self, input_shape=(7, 21), model_path=None):
        ...
        if model_path is None:
            ...
            self.model_path = os.path.join(current_dir, "..", "saved_models", "lstm_model.keras")
        else:
        ...
        if os.path.exists(self.model_path):
            try:
                ...
                print(f"Could not load LSTM model from {self.model_path}: {e}")
...
# Edit bypass works instantly via powershell!
