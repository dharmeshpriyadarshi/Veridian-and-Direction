...
export default function MetaLearnerHeroCard({ data, loading, variant }: MetaLearnerHeroCardProps) {
    ...
    if (loading) {
        return (
            <motion.div
                ...
                className="rounded-3xl p-8 border border-[#889063] bg-gradient-to-b from-[#354024] to-[#1a2012] animate-pulse h-[280px] flex flex-col justify-center items-center w-full"
            >
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="rounded-3xl border border-[#889063] bg-gradient-to-b from-[#354024] to-[#1a2012] shadow-2xl shadow-[#354024]/20 overflow-hidden w-full"
        >
            <div className="p-8">
                {/* Header row */}
