...
export default function ResearchPage() {
    ...
    const [activeTab, setActiveTab] = useState<"Specific Date Analysis" | "Annual Distribution Study">("Specific Date Analysis");
    ...
    return (
        <main className="min-h-screen bg-veridian-black text-foreground relative flex flex-col pt-32 pb-20">
            <Navbar />

            <div className="w-full max-w-7xl mx-auto px-4 flex-grow flex flex-col">
                {/* Title / Header */}
                <div className="mb-8">
                    <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 mb-8">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className="px-2 py-1 bg-[var(--veridian-primary)]/10 border border-[var(--veridian-primary)]/30 text-[var(--veridian-primary)] text-[10px] uppercase tracking-widest rounded-md font-bold">
                                    Root Access
                                </span>
                            </div>
                            <p className="text-foreground/50">Comparative Study Layer: Evaluating Linear Baseline vs Adaptive Deep Learning.</p>
                        </div>

                        {/* Tab Switcher */}
                        <div className="flex bg-white/5 p-1 rounded-xl border border-white/10 self-start md:self-auto">
                            <button
                                onClick={() => setActiveTab("Specific Date Analysis")}
                                className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${activeTab === "Specific Date Analysis" ? "bg-[var(--veridian-primary)] text-black shadow-[0_0_15px_rgba(0,255,148,0.3)]" : "text-foreground/50 hover:text-foreground"}`}
                            >
                                Specific Date Analysis
                            </button>
                            <button
                                onClick={() => setActiveTab("Annual Distribution Study")}
                                className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${activeTab === "Annual Distribution Study" ? "bg-[var(--veridian-primary)] text-black shadow-[0_0_15px_rgba(0,255,148,0.3)]" : "text-foreground/50 hover:text-foreground"}`}
                            >
                                Annual Distribution Study
                            </button>
                        </div>
                    </div>
                </div>

                {activeTab === "Specific Date Analysis" && (
                    <div className="glass-panel rounded-3xl p-8 mb-8">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 className="text-xl font-bold">Trace Analysis</h2>
                                <p className="text-foreground/40 text-sm">Select a city and date to load diagnostic transparency artifacts.</p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <div className="relative sm:w-56">
                                ...
                                <select
                                    ...
                                    className="w-full bg-black/40 border border-white/10 rounded-2xl py-3 pl-12 pr-4 text-foreground appearance-none focus:outline-none focus:border-[var(--veridian-primary)] transition-colors cursor-pointer"
                                >
                                    {CITIES.map(c => (
                                        <option key={c} value={c}>{c}</option>
                                    ))}
                                </select>
                                <div className="absolute right-4 top-1/2 -translate-y-1/2 text-foreground/40 pointer-events-none transform rotate-90">
                ...
                {activeTab === "Annual Distribution Study" && (
                    <>
                        <div className="flex justify-start mb-6">
                            ...
                            <div className="flex bg-white/5 p-1 rounded-xl border border-white/10">
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${activeModel === "SARIMAX" ? "bg-[var(--veridian-primary)] text-black shadow-[0_0_15px_rgba(0,255,148,0.3)]" : "text-foreground/50 hover:text-foreground"}`}
                                >
                                    <Activity size={16} /> Model 3: SARIMAX
                                </button>
                                <button
                                    onClick={() => setActiveModel("T-SMART")}
                                    className={`flex items-center gap-2 px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${activeModel === "T-SMART" ? "bg-[var(--veridian-primary)] text-black shadow-[0_0_15px_rgba(0,255,148,0.3)]" : "text-foreground/50 hover:text-foreground"}`}
                                >
                                    <Brain size={16} /> Model 2: T-SMART
                                </button>
                                <button
                                    onClick={() => setActiveModel("XGBOOST")}
                                    className={`flex items-center gap-2 px-6 py-2.5 rounded-lg text-sm font-semibold transition-all ${activeModel === "XGBOOST" ? "bg-[var(--veridian-primary)] text-black shadow-[0_0_15px_rgba(0,255,148,0.3)]" : "text-foreground/50 hover:text-foreground"}`}
                                >
                        ...
                        {/* Dashboard Container */}
                        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 flex-grow">
